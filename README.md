...
both EC2 instances to eliminate the compute charge. Stop/start has private IPs preserved
...
the SSM agent needs some time to re-register after boot. You can confirm both are ready with:
